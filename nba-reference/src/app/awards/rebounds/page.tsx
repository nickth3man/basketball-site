...
import { getReboundsLeaders } from '@/lib/queries/awards/stat-leaders';
import {
  tableBodyRowClass,
  tableCellClass,
  tableClass,
...
export default function ReboundsLeadersPage(): React.JSX.Element {
  const leaders = getReboundsLeaders();
  ...
  return (
    <main className="mx-auto min-h-screen max-w-6xl px-4 py-6">
      <div className="mb-6">
        ...
        <h1 className="text-3xl font-bold text-heading">Rebounds Leaders</h1>
        <p className="mt-1 text-muted">
          Player with the highest rebounds per game each NBA season (min. 25 games).
        </p>
      </div>

      <section className="panel-paper p-4">
        <h2 className="mb-3 text-xl font-bold text-heading">Rebounds Leaders by Season</h2>
          ...
          <table className={tableClass}>
            <thead>
              <tr className={tableHeadRowClass}>
                ...
                <th className={tableHeaderCellClass('right')}>RPG</th>
              </tr>
            </thead>
            <tbody>
