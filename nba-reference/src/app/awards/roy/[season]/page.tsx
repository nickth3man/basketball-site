...
import { getROYVotingBySeason } from '@/lib/queries';
...
export default async function ROYVotesPage({
  ...
  return (
    <main className="mx-auto max-w-7xl px-4 py-6">
      ...
      <h1 className="mb-2 text-3xl font-bold">ROY Voting - {seasonId}</h1>
      <p className="mb-4 text-sm text-muted-strong">
        Full voting breakdown for the NBA Rookie of the Year Award.
      </p>
