...
import { getAllRookieHistory } from '@/lib/queries/awards';
import {
  tableBodyRowClass,
  tableCellClass,
  tableClass,
...
export default function AllRookiePage(): React.JSX.Element {
  const selections = getAllRookieHistory();
  ...
  return (
    <main className="mx-auto min-h-screen max-w-6xl px-4 py-6">
      <div className="mb-6">
        ...
        <h1 className="text-3xl font-bold text-heading">All-Rookie Teams</h1>
        <p className="mt-1 text-muted">
          First-team and second-team All-Rookie selections by season (5 players per team).
        </p>
      </div>

      <section className="panel-paper p-4">
        <h2 className="mb-3 text-xl font-bold text-heading">All-Rookie Selections by Season</h2>
          ...
          <table className={tableClass}>
            <thead>
              <tr className={tableHeadRowClass}>
                ...
                <th className={tableHeaderCellClass('left')}>Club</th>
              </tr>
            </thead>
            <tbody>
