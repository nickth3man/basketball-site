...
import { getMVPHistory } from '@/lib/queries/awards';
import {
  tableBodyRowClass,
  tableCellClass,
  tableClass,
  ...
  return (
    <main className="mx-auto min-h-screen max-w-6xl px-4 py-6">
      <div className="mb-6">
        ...
        <h1 className="text-3xl font-bold text-heading">Most Valuable Player (MVP)</h1>
        <p className="mt-1 text-muted">The Michael Jordan Trophy - NBA MVP Award Winners</p>
      </div>

      <section className="panel-paper p-4">
        <h2 className="mb-3 text-xl font-bold text-heading">MVP Winners by Season</h2>
