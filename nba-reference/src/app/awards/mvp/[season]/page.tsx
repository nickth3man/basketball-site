...
import { getMVPVotingBySeason } from '@/lib/queries/awards';
...
export default async function MVPVotesPage({
  ...
  return (
    <main className="mx-auto max-w-7xl px-4 py-6">
      ...
      <h1 className="mb-2 text-3xl font-bold">NBA MVP Voting - {seasonId}</h1>
      <p className="mb-4 text-sm text-muted-strong">
        Full voting breakdown for the Most Valuable Player award.
      </p>
